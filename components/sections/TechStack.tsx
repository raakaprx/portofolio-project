...
const TECH_GROUPS: TechGroup[] = [
  {
    ...
    items: [
      ...
      { name: "Bootstrap", logo: BootstrapLogo, proficiency: "Proficient" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Socket.IO", logo: SocketdotioLogo, proficiency: "Advanced" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Supabase", logo: SupabaseLogo, proficiency: "Advanced" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Postman", logo: PostmanLogo, proficiency: "Proficient" },
      { name: "Figma", logo: FigmaLogo, proficiency: "Proficient" },
      { name: "Vercel", logo: VercelLogo, proficiency: "Proficient" },
    ],
  },
];
